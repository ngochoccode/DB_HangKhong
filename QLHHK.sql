...
CREATE TABLE HANH_KHACH (
    MaHanhKhach VARCHAR2(10) PRIMARY KEY,
    ...
    ViTriGhe VARCHAR2(10)
);

ALTER TABLE HANH_KHACH
ADD CONSTRAINT chk_HKhach_HangGhe CHECK (HangGhe IN ('Economy', 'Premium Economy', 'Business', 'First Class'));
...
ALTER TABLE NHAN_VIEN ADD ACCOUNT_ID NUMBER(10);

ALTER TABLE NHAN_VIEN
ADD CONSTRAINT uq_account_id UNIQUE (ACCOUNT_ID);

ALTER TABLE NHAN_VIEN
ADD CONSTRAINT FK_nhanVien_account FOREIGN KEY(ACCOUNT_ID) REFERENCES ACCOUNT(ACCOUNT_ID)
ON DELETE CASCADE;
...
ALTER TABLE NHAN_VIEN
ADD CONSTRAINT UNIQUE_NHANVIEN_CCCD UNIQUE(CCCD);
ALTER TABLE NHAN_VIEN
ADD CONSTRAINT UNIQUE_NHANVIEN_EMAIL UNIQUE(EMAIL);
ALTER TABLE NHAN_VIEN
ADD CONSTRAINT UNIQUE_NHANVIEN_SDT UNIQUE(SDT);
...
CREATE TABLE CT_DICH_VU (
		MaHanhKhach VARCHAR2(10),
		MaDichVu VARCHAR2(10),
		GhiChu NVARCHAR2(1000) 
);
ALTER TABLE CT_DICH_VU
ADD CONSTRAINT PK_CTDICHVU PRIMARY KEY(MaHanhKhach, MaDichVu);

CREATE TABLE CT_GOI_HANH_LY (
		MaHanhKhach VARCHAR2(10),
...
-- TẠO BẢNG SO_DO_GHE
CREATE TABLE CHUYEN_BAY_GHE (
    MaChuyenBay VARCHAR2(10),
    ViTriGhe VARCHAR2(10),
    HangGhe VARCHAR2(20),
    TrangThaiGhe NVARCHAR2(20) NOT NULL,
    PRIMARY KEY (MaChuyenBay,ViTriGhe)
);

ALTER TABLE CHUYEN_BAY_GHE
ADD CONSTRAINT chk_CBGhe_HangGhe CHECK(HangGhe IN ('Economy', 'Premium Economy', 'Business', 'First Class')) ;

ALTER TABLE CHUYEN_BAY_GHE
ADD CONSTRAINT chk_CBGhe_TrangThaiGhe CHECK(TrangThaiGhe IN ('Trống', 'Đang giữ', 'Đã xác nhận' )) ;
-- TẠO BẢNG TUYEN_BAY
...
CREATE TABLE HANH_LY (
    ...
    MaGoiHanhLy VARCHAR2(10) NOT NULL,
    MaHanhKhach VARCHAR2(15) NOT NULL,
...
ALTER TABLE HANH_LY
ADD CONSTRAINT chk_HanhLy_TrangThai CHECK(TrangThai IN ('Chưa gửi', 'Đã gửi', 'Đang vận chuyển', 'Đã nhận'));

CREATE TABLE GOI_HANH_LY (
    MaGoiHanhLy VARCHAR2(10) PRIMARY KEY,
    TenGoiHanhLy NVARCHAR2(20),
    TrongLuongMax NUMBER (5,2),
    GiaTien NUMBER(10,2)
);

ALTER TABLE GOI_HANH_LY
ADD CONSTRAINT chk_GoiHanhLy_TrongLuong CHECK(TrongLuongMax >= 0);

-- Tạo ràng buộc toàn vẹn khóa ngoại

ALTER TABLE HANH_KHACH
ADD CONSTRAINT fk_HanhKhach_Ve FOREIGN KEY (MaVe) REFERENCES VE_MAY_BAY(MaVe)
ON DELETE CASCADE;
...
ALTER TABLE CT_DICH_VU
ADD CONSTRAINT fk_CTDichVu_HanhKhach FOREIGN KEY (MaHanhKhach) REFERENCES HANH_KHACH(MaHanhKhach)
ON DELETE CASCADE;
...
ALTER TABLE CT_GOI_HANH_LY
ADD CONSTRAINT fk_CTGoiHanhLy_HanhKhach FOREIGN KEY (MaHanhKhach) REFERENCES HANH_KHACH(MaHanhKhach)
ON DELETE CASCADE;

ALTER TABLE CT_GOI_HANH_LY
ADD CONSTRAINT fk_CTGoiHanhLy_GoiHanhLy FOREIGN KEY (MaGoiHanhLy) REFERENCES GOI_HANH_LY(MaGoiHanhLy)
ON DELETE CASCADE;
...
ALTER TABLE CHUYEN_BAY_GHE
ADD CONSTRAINT fk_CBGhe_ChuyenBay FOREIGN KEY(MaChuyenBay) REFERENCES CHUYEN_BAY(MaChuyenBay)
ON DELETE CASCADE;
...
ALTER TABLE HANH_LY
ADD CONSTRAINT FK_HanhLy_GoiHanhLy FOREIGN KEY(MaGoiHanhLy) REFERENCES GOI_HANH_LY(MaGoiHanhLy)
ON DELETE CASCADE;

ALTER TABLE HANH_LY
ADD CONSTRAINT FK_HanhLy_HanhKhach FOREIGN KEY(MaHanhKhach) REFERENCES HANH_KHACH(MaHanhKhach)
ON DELETE CASCADE;
